...
public class Bord {
        ...
        private static final int AANTAL_VAKJES = 43; // Totaal aantal vakjes op het bord
        private static final int MIDDEN_VAK_INDEX = 0; // Index van het middenvak
        ...
        public List<Veld> getMogelijkeBestemmingen(int spelerX, int spelerY, int aantalZetten) {
